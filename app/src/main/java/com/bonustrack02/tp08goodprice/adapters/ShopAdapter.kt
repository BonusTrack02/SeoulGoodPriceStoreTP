...
class ShopItemAdapter : ListAdapter<Shop, ShopItemAdapter.ShopViewHolder>(ShopItemComparator()) {
    inner class ShopViewHolder(itemView: View, private val context: Context) : ViewHolder(itemView) {
        ...
        fun bind(item: Shop) {
            ...
            Glide.with(context).load(item.shopImage).into(binding.imgShop)
        }
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ShopViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.recycler_shop_item, parent, false)
