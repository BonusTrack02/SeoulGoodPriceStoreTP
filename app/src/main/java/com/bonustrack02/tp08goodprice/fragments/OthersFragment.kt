package com.bonustrack02.tp08goodprice.fragments
...
class OthersFragment : Fragment() {
    ...
    private suspend fun getShopList(startIndex: Int, endIndex: Int): MutableList<Shop> =
        try {
            val response = retrofitService.getShopListJson(apiKey, startIndex, endIndex, "004")
